...
public partial class NorthwindContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasOne(d => d.EmployeeNavigation).WithOne(p => p.InverseEmployeeNavigation).OnDelete(DeleteBehavior.ClientSetNull);
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.HasOne(d => d.ProductNavigation).WithOne(p => p.Product).OnDelete(DeleteBehavior.ClientSetNull);
        });
